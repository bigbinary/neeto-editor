...
export const isEditorTippyContentHidden = () =>
  !document.getElementsByClassName("tippy-content")?.length;

export const isEditorImageModalHidden = () =>
  !document.getElementsByClassName("ne-media-uploader")?.length;

export const isEditorOverlaysActive = () =>
  isEditorTippyContentHidden() && isEditorImageModalHidden();
