...
const LinkOption = ({ editor, handleClose, handleAnimateInvalidLink }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="neeto-editor-bubble-menu__form">
      <input
        autoFocus
        name="url"
        value={link}
        ...
        className="neeto-editor-bubble-menu__item neeto-editor-bubble-menu-form__input"
      />
      <Button icon={Close} onClick={handleReset} />
    </form>
  );
};
