...
export const buildImageOptions = editor => [
  {
    Icon: LeftAlign,
    command: () =>
      editor.chain().focus().setImageAttributes({ align: "left" }).run(),
  ...
  },
  {
    Icon: CenterAlign,
    command: () =>
      editor.chain().focus().setImageAttributes({ align: "center" }).run(),
  ...
  },
  {
    Icon: RightAlign,
    command: () =>
      editor.chain().focus().setImageAttributes({ align: "right" }).run(),
    active: editor.isActive("image", { align: "center" }),
