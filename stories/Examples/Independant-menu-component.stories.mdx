...
import Menu from "@bigbinary/neeto-editor/Menu";
...
You may pass an `options` prop instead of `defaults` and `addons` props to
control the options that are rendered in the indenepdant menu component.
