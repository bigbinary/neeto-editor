...
> You have to install the following peer dependency to use the **EditorContent**
> component
...
```html
<link
  href="https://cdn.jsdelivr.net/gh/bigbinary/neeto-editor-tiptap@master/dist/editor-content.min.css"
  rel="stylesheet"
/>
```
