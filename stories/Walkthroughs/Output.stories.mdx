...
```html
<link
  href="https://cdn.jsdelivr.net/gh/bigbinary/neeto-editor@main/dist/editor-content.min.css"
  rel="stylesheet"
/>
```
...
<script
  ...
  src="https://cdn.jsdelivr.net/gh/bigbinary/neeto-editor@main/dist/codeBlockHighlight.js"
></script>
```
